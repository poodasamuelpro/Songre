  ...
  const fr = [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'SONGRE respecte-t-il la loi burkinabè sur les données personnelles ?', a: 'Oui. SONGRE s\'engage à respecter la loi n°010-2004/AN du Burkina Faso relative à la protection des données à caractère personnel, ainsi que les recommandations de l\'Autorité Nationale de Protection des Données à Caractère Personnel (ANPDP).' },
  ...
  const en = [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Does SONGRE comply with Burkinabè personal data law?', a: 'Yes. SONGRE is committed to complying with Burkina Faso law n°010-2004/AN on personal data protection, as well as the recommendations of the National Authority for Personal Data Protection (ANPDP).' },
