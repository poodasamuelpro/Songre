...
export const seoData: Record<string, Record<string, SEOMeta>> = {
  fr: {
    ...
    about: {
      ...
      locale: 'fr_BF',
      alternateLocale: 'en',
      alternateUrl: `${BASE_URL}/en/about`,
    },
    security: {
      ...
      canonical: `${BASE_URL}/fr/securite`,
      locale: 'fr_BF',
      alternateLocale: 'en',
      alternateUrl: `${BASE_URL}/en/security`,
    },
    faq: {
    ...
    contact: {
      ...
      locale: 'fr_BF',
      alternateLocale: 'en',
      alternateUrl: `${BASE_URL}/en/contact`,
    },
    cgu: {
      ...
      canonical: `${BASE_URL}/fr/cgu`,
      locale: 'fr_BF',
      alternateLocale: 'en',
      alternateUrl: `${BASE_URL}/en/terms`,
    },
    privacy: {
      ...
      canonical: `${BASE_URL}/fr/confidentialite`,
      locale: 'fr_BF',
      alternateLocale: 'en',
      alternateUrl: `${BASE_URL}/en/privacy`,
    },
  },
  en: {
    home: {
    ...
    about: {
      ...
      locale: 'en_BF',
      alternateLocale: 'fr',
      alternateUrl: `${BASE_URL}/fr/a-propos`,
    },
    security: {
      ...
      canonical: `${BASE_URL}/en/security`,
      locale: 'en_BF',
      alternateLocale: 'fr',
      alternateUrl: `${BASE_URL}/fr/securite`,
    },
    faq: {
    ...
    contact: {
      ...
      locale: 'en_BF',
      alternateLocale: 'fr',
      alternateUrl: `${BASE_URL}/fr/contact`,
    },
    terms: {
    ...
    privacy: {
      ...
      locale: 'en_BF',
      alternateLocale: 'fr',
      alternateUrl: `${BASE_URL}/fr/confidentialite`,
    },
  },
};

export function generateHead(seo: SEOMeta, jsonLd?: object): string {
